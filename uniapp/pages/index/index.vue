<template>
  <view class="container">
    ...
    <view class="card recent-section">
      ...
      <!-- 账单列表 -->
      <view v-else>
        <template v-for="(item, index) in recentGroups" :key="item.date">
...
<script>
const { getMonthSummary, groupByDate, formatDate, getMonthBudget, setMonthBudget } = require('../../utils/storage.js')
